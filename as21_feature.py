...
from as_data_augmentation import augment_audio
from as_feature import extract_feature
from asvspoof19.as19_util import read_protocol
from util.util import clear_dir

if os.name == 'posix':
    data_path_19 = r'/home/lzc/lzc/ASVspoof/DS_10283_3336'
    feat_path_19 = r'/home/lzc/lzc/ASVspoof/ASVspoof2019feat'
    data_path_21 = r'/home/lzc/lzc/ASVspoof/ASVspoof2021data'
    feat_path_21 = r'/home/lzc/lzc/ASVspoof/ASVspoof2021feat'
elif os.name == 'nt':
    data_path_19 = r'/home/lzc/lzc/ASVspoof/DS_10283_3336'
    feat_path_19 = r'/home/lzc/lzc/ASVspoof/ASVspoof2019feat'
    data_path_21 = r'/home/lzc/lzc/ASVspoof/ASVspoof2021data'
...
if __name__ == '__main__':
    ...
    # extract_feature_asvspoof19(feature_type, access_type='PA', aug_methods=aug_methods)
